...
########## HELPER FUNCTIONS ##########
#using the same summ_stats as practice activity 2, slightly modified to include n observed.
...
```{r}
#| label: web scraping WHO website using iteration 

library(rvest)

# link: https://immunizationdata.who.int/global/wiise-detail-page/measles-vaccination-coverage?CODE=Global&ANTIGEN=&YEAR=&ADVANCED_GROUPINGS=AMRO <- editing the groupings

web_data <- read_html("https://immunizationdata.who.int/global/wiise-detail-page/measles-vaccination-coverage?CODE=Global&ANTIGEN=&YEAR=&ADVANCED_GROUPINGS=AMRO")

web_data |> html_elements("table")
web_data |> html_elements(".wiise-data-table__value")
